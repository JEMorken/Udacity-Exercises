...
The following is my set of notes/results from performing the first Udacity Diamonds Promblem set.
...
Udacity directions included [in order below]: changing the limits (Dark Green), binwidths (Green), and breaks (Light Green).  
...
Additional instructions - Also use numerical summaries and one of the following categorical variables: cut, clarity, or color. Then use a boxplot to illustrate price/carat by color.
